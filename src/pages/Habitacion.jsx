...
import ModalEliminarHabitacion from "../components/ModalEliminarHabitacion"
...
const Habitacion = () => {
  ...
  const [eliminarProyeto, setEliminarHabitacion ] = useState(false)
  ...
  const tareasFiltradas = habitacion.tareas?.filter((tarea) => {
    if (filtro === true) {
  ...
  return (
    <>
      <div className="lg:flex lg:flex-row lg:mt-20 items-center justify-between">
        ...
        <div className='flex justify-center lg:justify-between gap-4 lg:mr-24'>
          ...
          <div className='flex items-center gap-2 text-gray-400 hover:text-black'>
              <button
                  className='uppercase text-sm font-bold'
                  onClick={()=>setEliminarHabitacion(!eliminarProyeto)}
              >Eliminar</button>
      ...
      <p className="font-bold text-xl mt-10">Tareas del Habitacion</p>
      ...
      <div className="mt-6">
        { habitacion.tareas?.length ? 
         tareasFiltradas.map( tarea => (
          ...
          <p className="text-center my-5 p-10">No hay tareas en este habitacion</p>
      ...
      <ModalEliminarHabitacion habitacionId={id} habitacionEliminar={eliminarProyeto} setEliminarHabitacion={setEliminarHabitacion}/>
    </>
